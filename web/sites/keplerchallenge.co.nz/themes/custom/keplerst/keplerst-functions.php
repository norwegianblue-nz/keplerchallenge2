 ...
 * @return mixed
 */
function keplerst_return_clean_breakpoint_id(\Drupal\breakpoint\Breakpoint $breakpoint) {
 ...
 */
function keplerst_return_layouts($theme) {
 ...
 * @return int|string
 */
function keplerst_find_layout_provider($theme) {
 ...
 */
function keplerst_return_active_layout() {
  ...
  $layoutProvider = keplerst_find_layout_provider($theme);
  //dpm($layoutProvider);
